...
import com.sidutti.charlie.aipipeline.model.ConfluenceConfig;
import com.sidutti.charlie.aipipeline.model.CsvConfig;
import com.sidutti.charlie.aipipeline.model.DataSourceConfig;
import com.sidutti.charlie.aipipeline.model.EcmRepoConfig;
import com.sidutti.charlie.aipipeline.model.JsonPathConfig;
import com.sidutti.charlie.aipipeline.model.KafkaConfig;
import com.sidutti.charlie.aipipeline.model.ObjectStorageConfig;
import com.sidutti.charlie.aipipeline.model.PipelineConfig;
import com.sidutti.charlie.aipipeline.model.SharepointConfig;
import com.sidutti.charlie.aipipeline.model.TargetConfig;
import com.sidutti.charlie.aipipeline.model.UrlListConfig;
import com.sidutti.charlie.aipipeline.model.WebhookConfig;
...
public class ConfigurationAgentService {
    ...
    private List<String> getQuestionsForDataSource(String dataSourceType) {
        return switch (dataSourceType.toLowerCase()) {
            ...
            default ->
                    List.of("Unknown data source type. Please specify: confluence, ecm, sharepoint, objectstorage, urllist, csv, kafka, or webhook");
        };
    }
    ...
    private static class ConfigurationSession {
        ...
        public boolean isTargetConfigStarted() {
            return targetConfigStarted;
        }

        public void setTargetConfigStarted(boolean targetConfigStarted) {
            this.targetConfigStarted = targetConfigStarted;
        }

        public Map<Integer, String> getTargetAnswers() {
